...
// Vendored from cult-ui (https://cult-ui.com/r/expandable-screen.json).
// Only change from upstream: the overlay sits at z-60 so it covers a z-50 site nav.
...
export function ExpandableScreen({
  ...
  useEffect(() => {
    ...
    /*
      LOCAL PATCH. Two problems upstream: body overflow does not hold this site,
      because Lenis scrolls documentElement from wheel events, and there was no
      cleanup, so unmounting while expanded left the page permanently unscrollable.
      This pauses Lenis as well and restores both on the way out.
    */
